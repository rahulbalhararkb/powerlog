...
class UpdateDefect extends StatefulWidget {
  final Note note;
  UpdateDefect(this.note);

  @override
  State<StatefulWidget> createState() => new _UpdateDefectState();
}

class _UpdateDefectState extends State<UpdateDefect> {
  ...
  void initState() {
    super.initState();
    _unit = widget.note.unit;
    _stage = widget.note.stage;
    _area = widget.note.area;
    _jobstatus = widget.note.jobstatus;
    _jobtype = widget.note.jobtype;
